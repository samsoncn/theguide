...
//               <div
//                 key={index}
//                 className={`text-base text-white flex items-center mb-4 p-4 rounded-lg w-[80%] shadow-lg shadow-[#000000] hide-scrollbar bg-gradient-to-r from-[#0b235a] to-slate-600 ${message.role === "bot" && 'bg-gradient-to-r from-slate-900 to-[#0d072f] text-slate-100'}`}
//               >
